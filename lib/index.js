...
const defaultSectionHeaderColor = "#FFF";
const defaultSectionHeaderTextColor = "#000";
...
export default class Timeline extends Component {
  ...
  _renderSectionHeader(sectionData, sectionText) {
    return (
      <View style={[styles.sectionHeader, this.props.sectionHeaderStyle]}>
        <Text style={[styles.sectionHeaderText, this.props.sectionHeaderTextStyle]}>{sectionText}</Text>
      </View>
    )
  }
  ...
  _renderEvent(rowData, sectionID, rowID, highlightRow) {
    ...
    return (
      ...
      >
        ...
        >
          <View style={[styles.detail,this.props.detailContainerViewStyle]}>
...
const styles = StyleSheet.create({
  ...
  sectionHeader: {
    marginBottom: 15,
    backgroundColor: defaultSectionHeaderColor,
    height: 30,
    justifyContent: "center"
  },
  sectionHeaderText: {
    color: defaultSectionHeaderTextColor,
    fontSize: 18,
    alignSelf: "center"
  },
  rowContainer: {
